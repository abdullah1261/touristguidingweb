  ...
  return (
    <>
      <header className={props.className}>
        <div className="flex md:flex-col flex-row md:gap-5 items-center justify-center md:ml-[0] ml-[25px] mr-[35px] w-[97%]">
          ...
          <Img
            ...
            className="common-pointer h-[25px] sm:hidden ml-4 md:ml-[0] w-auto"
