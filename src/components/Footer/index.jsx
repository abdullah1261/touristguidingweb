  ...
  return (
    <>
      <footer className={props.className}>
        <div className="sm:h-[250px] h-[356px] md:h-[461px] relative w-full">
          <div className="absolute bottom-[0] flex h-[239px] sm:h-[250px] md:h-[461px] inset-x-[0] justify-end mx-auto w-full">
            ...
            <div className="absolute bottom-[0] flex flex-col gap-[23px] inset-x-[0] justify-start mx-auto w-[27%]">
