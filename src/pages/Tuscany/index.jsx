      ...
      <div className="bg-orange_200 flex flex-col items-center justify-start mx-auto pb-1 w-full">
        <div className="flex flex-col justify-start w-full">
          ...
          <div className="font-roboto h-[367px] md:h-[461px] md:px-5 relative w-full">
            <Img
              src="images/img_t2_367x1600.png"
            ...
            <div className="absolute bottom-[5%] flex md:flex-col flex-row md:gap-5 inset-x-[0] items-end justify-start mx-auto w-[86%]">
              <Img
                ...
                className="h-[106px] sm:h-auto mb-1.5 object-cover rounded-[50px] w-[9%] md:w-full"
                alt="t3"
              />
              <Text
                className="font-medium mb-2.5 md:ml-[0] ml-[23px] md:mt-0 mt-[54px] text-left text-white_A700 w-auto"
                variant="body2"
              >
                Tuscany Courtyard
              </Text>
              <Img
                ...
                className="h-[50px] md:ml-[0] ml-[591px] md:mt-0 mt-[62px] w-auto"
                alt="television"
              />
              <Text
                className="font-medium mb-4 ml-5 md:ml-[0] md:mt-0 mt-[66px] text-center text-white_A700 w-auto"
                variant="body8"
              >
                Review
              </Text>
              ...
              <Text
                className="font-medium mb-[15px] md:ml-[0] ml-[25px] md:mt-0 mt-[66px] text-center text-white_A700 w-auto"
                variant="body8"
              >
                Save
              </Text>
          ...
          <div className="bg-lime_800 border border-black_900 border-solid flex flex-row font-librebodoni items-center justify-start p-1.5 shadow-bs1 w-full">
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start ml-[54px] mt-[13px] md:px-5 w-[68%]">
              ...
              <Text
                ...
                variant="body12"
              >
                16-C-1 MM Alam Rd, Block C1 Block C 1 Gulberg III, Lahore
                Pakistan
              </Text>
              <Img
              ...
              <Img
                ...
                className="h-5 md:ml-[0] ml-[60px] md:mt-0 mt-0.5 w-5"
                alt="dashiconsadmins"
              />
              <a
          ...
          <div className="flex md:flex-col flex-row font-robotoflex gap-[22px] items-center justify-start md:ml-[0] ml-[76px] mt-[19px] md:px-5 w-[86%] md:w-full">
            ...
            <div className="flex flex-col items-end justify-start outline outline-black_900 pl-[7px] py-[7px] shadow-bs1 w-[30%] md:w-full">
              <div className="flex flex-col items-start justify-start mb-[26px] w-[97%] md:w-full">
                ...
                <div className="flex flex-row font-librebodoni items-center justify-start ml-1 md:ml-[0] mt-[39px] w-[58%] md:w-full">
                  <Img
          ...
          <Text
            className="font-librebodoni md:ml-[0] ml-[554px] mt-[62px] not-italic text-black_900 text-center w-auto"
            variant="body5"
          >
            You may also be interested in
          </Text>
          <div className="font-roboto h-[671px] mt-[21px] md:px-5 relative w-full">
            <div className="flex md:flex-col flex-row gap-4 items-center justify-start mb-[-23.49px] ml-[76px] pl-[3px] pt-[3px] w-[87%] z-[1]">
              <div
