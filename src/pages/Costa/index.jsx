    ...
    <>
      <div className="bg-orange_200 flex flex-col items-center justify-start mx-auto pb-1 w-full">
        <div className="flex flex-col justify-start w-full">
          ...
          <div className="font-roboto sm:h-[366px] h-[367px] md:h-[420px] md:px-5 relative w-full">
            <Img
              src="images/img_cc21.png"
              className="h-[366px] m-auto object-cover w-full"
              alt="ccTwentyOne"
            />
            <div className="absolute bottom-[5%] flex md:flex-col flex-row md:gap-5 inset-x-[0] items-start justify-start mx-auto w-[86%]">
              <Img
                ...
                className="h-28 md:h-auto object-cover rounded-[50px] w-28"
                alt="cc3"
              />
              <Text
                className="font-medium md:ml-[0] ml-[23px] md:mt-0 mt-[50px] text-left text-white_A700 w-auto"
                variant="body2"
              >
                Cafe Costa
              </Text>
              <Img
                ...
                className="h-[50px] md:ml-[0] ml-[728px] md:mt-0 mt-[62px] w-auto"
                alt="television"
              />
              <Text
                className="font-medium md:ml-[0] ml-[22px] md:mt-0 mt-[66px] text-center text-white_A700 w-auto"
                variant="body8"
              >
                Review
              </Text>
              <HaveliLike1 className="bg-gray_100 flex flex-col items-center justify-start mb-1.5 md:ml-[0] ml-[22px] md:mt-0 mt-[61px] p-[3px] rounded-[22px] w-auto md:w-full" />
              <Text
                className="font-medium md:ml-[0] ml-[25px] md:mt-0 mt-[66px] text-center text-white_A700 w-auto"
                variant="body8"
              >
                Save
              </Text>
          ...
          <div className="flex md:flex-col flex-row font-robotoflex gap-[18px] items-center justify-start md:ml-[0] ml-[76px] mt-6 md:px-5 w-[86%] md:w-full">
            ...
            <div className="flex flex-col items-center justify-start outline outline-black_900 p-[7px] shadow-bs1 w-[30%] md:w-full">
              <div className="flex flex-col items-start justify-start mb-[26px] w-[90%] md:w-full">
                ...
                <div className="flex flex-row font-librebodoni items-center justify-start ml-1 md:ml-[0] mt-[39px] w-[46%] md:w-full">
                  <Img
          ...
          <Text
            className="font-librebodoni md:ml-[0] ml-[547px] mt-[50px] not-italic text-black_900 text-center w-auto"
            variant="body5"
          >
