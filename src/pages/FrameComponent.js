      ...
      >
        ...
        <div className="rectangle-group">
          ...
          <div className="gali-surjan-singh1">
            ...
            century physician who lived in the street. He had cured many royals
            and that is why the street was named after him and because of his
        ...
        <div className="group-wrapper">
          <div className="group-div">
            <div className="group-item" />
            <div className="lahore-railway-station">Lahore Railway Station</div>
            <div className="lahore-railway-station1">
              Lahore Railway Station, which is also known as the Lahore railway
              junction, is one of the oldest and busiest railway junctions in
              Pakistan. Dozens of passenger trains and cargo carriages make use
              of the Lahore junction station for large scale movements of the
              railway traffic.
            </div>
        ...
        <div className="group-container">
          <div className="group-div">
            ...
            <div className="joyland-is-a">
              ...
              established in 1977 and is one of the largest recreation parks in
              the city. It is spread out over an area of 6 acres.
            </div>
        ...
        <div className="group-frame">
          <div className="group-div">
            ...
            <div className="are-you-ready">
              ...
              are an adult, or a youngster looking for some extreme sport, 2F2F
              Karting has excellent opportunities for you.
            </div>
        ...
        <div className="group-wrapper1">
          <div className="group-div">
            ...
            <div className="located-in-emporium">
              Located in emporium mall, packages mall and mall of Lahore is one
              of the most fun games; Laser Tag. Laser tag is a recreational
              shooting sport where participants use infrared-emitting light guns
              to tag designated targets.
            </div>
      ...
      <div className="adrenaline-rush-parent" data-scroll-to="groupContainer">
        ...
        <div className="group-container">
          <div className="group-div">
            ...
            <div className="this-bazaar-is">
              This bazaar is well worth a visit. You need to witness the frenzy
              of activity to believe it. Shopping, eating or just watching the
              locals go about their business its an eye opener.For foodies,
              there is a spot selling the most insane chole abature which is
              definitely the in Lahore.
            </div>
        ...
        <div className="group-wrapper4">
          <div className="group-div">
            ...
            <div className="located-near-expo">
              Located near expo center ,this mall offers a unique experience of
              shopping, dining and fun for the kids. You cal find all sorts of
              modern and cultural stuff here.
            </div>
            <img
        ...
        <div className="group-wrapper1">
          <div className="group-div">
            ...
            <div className="located-in-emporium">
              It’s one of the most famous and historic markets in the city with
              tones of eateries, shopping outlets, and other attractions.
            </div>
            <img className="image-119-icon" alt="" src="/image-11911@2x.png" />
          </div>
        </div>
        <div className="group-wrapper2">
          <div className="group-div">
            ...
            <div className="anyone-approaching-delhi">
              ...
              visitor’s eyes all watery. The scent bringing tears to the eyes of
              all comers emanates from the range of spices available at Lahore’s
              Akbari Mandi.It is considered one of the largest spice markets in
              Asia and offers a panorama of colours.
            </div>
            <img className="image-119-icon" alt="" src="/image-11912@2x.png" />
          </div>
        </div>
        <div className="rectangle-parent6">
          <div className="group-item" />
          ...
          <div className="the-shah-almi-gate-container">
            <span className="emporium-mall-txt-container">
              ...
              Market" or Shahalmi as locals call it, exists near the site of the
              gate.
            </span>
          </div>
