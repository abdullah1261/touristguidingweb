...
const FrameComponent = () => {
  return (
    <div className={styles.groupParent}>
      <div className={styles.component1variant3Parent}>
        <div className={styles.component1variant3}>
          <div className={styles.component1variant3Child} />
          <img
            className={styles.component1variant3Item}
            alt=""
            src="/ellipse-16.svg"
          />
          <div className={styles.lahoreParent}>
            <div className={styles.lahore}>Lahore</div>
            <i className={styles.throughLens}>through lens</i>
          </div>
        ...
        <div className={styles.rectangleContainer}>
          ...
          <img className={styles.image41Icon1} alt="" src="/image-411@2x.png" />
          <img className={styles.image42Icon1} alt="" src="/image-421@2x.png" />
          <img className={styles.image43Icon1} alt="" src="/image-431@2x.png" />
