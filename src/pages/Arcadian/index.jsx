    ...
    <>
      <div className="bg-orange_200 flex flex-col items-center justify-start mx-auto pb-1 w-full">
        <div className="flex flex-col justify-start w-full">
          ...
          <div className="font-roboto h-[367px] md:h-[415px] md:px-5 relative w-full">
            <Img
            ...
            <div className="absolute bottom-[5%] flex md:flex-col flex-row md:gap-5 inset-x-[0] items-start justify-start mx-auto w-[87%]">
              <Img
                ...
                className="h-[107px] sm:h-auto object-cover rounded-[50px] w-[9%] md:w-full"
                alt="acTwentyTwo"
              />
              <Text
                className="font-medium md:ml-[0] ml-[39px] md:mt-0 mt-[45px] text-left text-white_A700 w-auto"
                variant="body2"
              >
                Arcadian Cafe
              </Text>
              <Img
                ...
                className="h-[50px] md:ml-[0] ml-[673px] md:mt-0 mt-[57px] w-auto"
                alt="television"
              />
              <Text
                className="font-medium md:ml-[0] ml-[22px] md:mt-0 mt-[61px] text-center text-white_A700 w-auto"
                variant="body8"
              >
                Review
              </Text>
              <HaveliLike1 className="bg-gray_100 flex flex-col items-center justify-start mb-1.5 md:ml-[0] ml-[22px] md:mt-0 mt-14 p-[3px] rounded-[22px] w-auto md:w-full" />
              <Text
                className="font-medium md:ml-[0] ml-[25px] md:mt-0 mt-[61px] text-center text-white_A700 w-auto"
                variant="body8"
              >
                Save
              </Text>
          ...
          <div className="flex md:flex-col flex-row font-robotoflex gap-[22px] items-center justify-start md:ml-[0] ml-[76px] mt-6 md:px-5 w-[86%] md:w-full">
            ...
            <div className="flex flex-col items-end justify-start outline outline-black_900 pl-[7px] py-[7px] shadow-bs1 w-[30%] md:w-full">
              <div className="flex flex-col items-start justify-start mb-[26px] w-[97%] md:w-full">
                ...
                <div className="flex flex-row font-librebodoni items-center justify-start ml-1 md:ml-[0] mt-[39px] w-[48%] md:w-full">
                  <Img
          ...
          <Text
            className="font-librebodoni md:ml-[0] ml-[555px] mt-[62px] not-italic text-black_900 text-center w-auto"
            variant="body5"
          >
            You may also be interested in
          </Text>
          <div className="font-roboto md:h-[641px] h-[676px] sm:h-[959px] mt-4 md:px-5 relative w-full">
            <List
              className="absolute sm:flex-col flex-row gap-3.5 grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 left-[5%] pb-[3px] px-[3px] top-[0] w-[87%]"
              ...
              >
                <div className="flex flex-col items-center justify-start w-full">
                  <div className="flex flex-col relative w-full">
                    ...
                    <Text
                      className="font-medium ml-8 mt-[-0.86px] text-left text-white_A700 w-auto z-[1]"
                      variant="body6"
                    >
                      Gloria Jeans
                    </Text>
