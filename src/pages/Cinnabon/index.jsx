    ...
    <>
      <div className="bg-orange_200 flex flex-col items-center justify-start mx-auto pb-1 w-full">
        <div className="flex flex-col justify-start w-full">
          ...
          <div className="font-roboto h-[367px] md:h-[423px] max-w-[1594px] mx-auto md:px-5 relative w-full">
            <Img
              src="images/img_c21_367x1594.png"
            ...
            <div className="absolute bottom-[5%] flex md:flex-col flex-row md:gap-5 inset-x-[0] items-start justify-start mx-auto w-[87%]">
              <Img
                ...
                className="h-[115px] md:h-auto object-cover rounded-[50px] w-[115px]"
                alt="c12"
              />
              <Text
                className="font-medium md:ml-[0] ml-[23px] md:mt-0 mt-[53px] text-left text-white_A700 w-auto"
                variant="body2"
              >
                Cinnabon
              </Text>
              <Img
                ...
                className="h-[50px] md:ml-[0] ml-[756px] md:mt-0 mt-[65px] w-auto"
                alt="television"
              />
              <Text
                className="font-medium md:ml-[0] ml-[22px] md:mt-0 mt-[69px] text-center text-white_A700 w-auto"
                variant="body8"
              >
                Review
              </Text>
              <HaveliLike1 className="bg-gray_100 flex flex-col items-center justify-start mb-1.5 md:ml-[0] ml-[22px] md:mt-0 mt-16 p-[3px] rounded-[22px] w-auto md:w-full" />
              <Text
                className="font-medium md:ml-[0] ml-[25px] md:mt-0 mt-[69px] text-center text-white_A700 w-auto"
                variant="body8"
              >
                Save
              </Text>
          ...
          <div className="bg-lime_800 border border-black_900 border-solid flex flex-row font-librebodoni items-center justify-start p-1.5 shadow-bs1 w-full">
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start ml-[54px] mt-[13px] md:px-5 w-[68%]">
              ...
              <Text
                ...
                variant="body12"
              >
                2B/3 Gulberg 3, Mian Mehmood Ali Kasuri Rd, Lahore 54660
                Pakistan
              </Text>
              <Img
              ...
              <div className="flex flex-col items-start justify-start mb-[26px] w-[90%] md:w-full">
                ...
                <div className="flex flex-row font-librebodoni items-start justify-start ml-1 md:ml-[0] mt-[39px] w-[91%] md:w-full">
                  ...
                  <Img
                    ...
                    className="h-5 ml-5 mt-0.5 w-auto"
                    alt="vector"
                  />
                  <Text
                    className="font-bold ml-[11px] text-black_900 text-center w-auto"
                    variant="body12"
                  >
                    Dine in
                  </Text>
                </div>
                <div className="flex flex-row font-librebodoni items-center justify-start ml-1 md:ml-[0] mt-[39px] w-[73%] md:w-full">
                  <Img
                ...
                <div className="flex flex-row font-librebodoni items-start justify-start ml-1 md:ml-[0] mt-[23px] w-[36%] md:w-full">
                  <Img
          ...
          <Text
            className="font-librebodoni md:ml-[0] ml-[554px] mt-[50px] not-italic text-black_900 text-center w-auto"
            variant="body5"
          >
          ...
          <div className="font-roboto h-[683px] mt-[21px] md:px-5 relative w-full">
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col relative w-[85%] sm:w-full">
                  <Text
                    className="font-medium text-left text-white_A700 w-auto"
                    variant="body6"
                  >
                  ...
                  <Text
                    className="font-medium mb-0.5 mt-[-0.01px] text-left text-white_A700 w-auto z-[1]"
                    variant="body12"
                  >
                    Desert,Cafe
                  </Text>
                  <HaveliRowgroup942 className="flex flex-row items-center justify-evenly ml-auto mt-[-NaNpx] w-[35%] sm:w-full z-[1]" />
                </div>
              </div>
            </List>
