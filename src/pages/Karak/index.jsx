    ...
    <>
      <div className="bg-orange_200 flex flex-col items-center justify-start mx-auto pb-1 w-full">
        <div className="flex flex-col justify-start w-full">
          ...
          <div className="font-roboto h-[367px] md:h-[469px] md:px-5 relative w-full">
            <Img
              src="images/img_k21_367x1600.png"
              className="h-[367px] m-auto object-cover w-full"
              alt="k21"
            />
            <div className="absolute bottom-[5%] flex md:flex-col flex-row md:gap-5 inset-x-[0] items-end justify-start mx-auto w-[86%]">
              <Img
                src="images/img_k1.png"
                className="h-28 md:h-auto mb-1 object-cover rounded-[50px] w-28"
                alt="k2"
              />
              <Text
                className="font-medium mb-3.5 ml-6 md:ml-[0] md:mt-0 mt-[54px] text-left text-white_A700 w-auto"
                variant="body2"
              >
                Karak Khel
              </Text>
              <Img
                ...
                className="h-[50px] md:ml-[0] ml-[734px] md:mt-0 mt-[66px] w-auto"
                alt="television"
              />
              <Text
                className="font-medium mb-4 md:ml-[0] ml-[22px] md:mt-0 mt-[70px] text-center text-white_A700 w-auto"
                variant="body8"
              >
                Review
              </Text>
              ...
              <Text
                className="font-medium mb-[15px] md:ml-[0] ml-[25px] md:mt-0 mt-[70px] text-center text-white_A700 w-auto"
                variant="body8"
              >
                Save
              </Text>
          ...
          <div className="bg-lime_800 border border-black_900 border-solid flex flex-row font-librebodoni items-center justify-start p-1.5 shadow-bs1 w-full">
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start ml-[54px] mt-[13px] md:px-5 w-[68%]">
              ...
              <Text
                ...
                variant="body12"
              >
                Lahore Ring Road Kamahan Exit Near Sui Gas Society, Lahore{" "}
              </Text>
              <Img
              ...
              <div className="flex flex-col items-start justify-start mb-[26px] w-[90%] md:w-full">
                ...
                <div className="flex flex-row font-librebodoni items-start justify-start ml-1 md:ml-[0] mt-[37px] w-[91%] md:w-full">
                  ...
                  <Img
                    ...
                    className="h-5 ml-[21px] w-auto"
                    alt="vector"
                  />
                  <Text
                    className="font-bold ml-2.5 text-black_900 text-center w-auto"
                    variant="body12"
                  >
                    Dine in
                  </Text>
                </div>
                <div className="flex flex-row font-librebodoni items-start justify-start ml-1 md:ml-[0] mt-[39px] w-[47%] md:w-full">
                  <Img
          ...
          <Text
            className="font-librebodoni md:ml-[0] ml-[560px] mt-[39px] not-italic text-black_900 text-center w-auto"
            variant="body5"
          >
            You may also be interested in
          </Text>
          <div className="font-roboto h-[683px] mt-8 md:px-5 relative w-full">
            <List
              className="sm:flex-col flex-row gap-3.5 grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 mb-[-14.49px] ml-[76px] pb-1.5 px-1.5 w-[87%] z-[1]"
              ...
              >
                <div className="flex flex-col items-center justify-start w-full">
                  ...
                  <div className="flex flex-row items-end justify-between mt-0.5 w-[85%] md:w-full">
                    <div className="md:h-[34px] h-[54px] mb-0.5 relative w-2/5">
                      <Text
                      ...
                      <Text
                        className="absolute bottom-[0] font-medium inset-x-[0] mx-auto text-left text-white_A700 w-max"
                        variant="body12"
                      >
                        Coffee & Tea,Cafe
                      </Text>
                    </div>
                    <HaveliRowgroup941 className="flex flex-row items-center justify-evenly mt-[34px] w-[35%] sm:w-full" />
                  </div>
                </div>
              </div>
              <div
