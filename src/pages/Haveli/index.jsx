      ...
      <div className="bg-orange_200 flex flex-col items-center justify-start mx-auto pb-1 w-full">
        <div className="flex flex-col justify-start w-full">
          <div className="font-roboto h-[438px] md:px-5 relative w-full">
            ...
            <div className="h-[367px] md:h-[421px] mt-auto mx-auto w-full">
              <Img
                src="images/img_h22.png"
                className="h-[367px] m-auto object-cover w-full"
                alt="h22"
              />
              <div className="absolute bottom-[3%] flex md:flex-col flex-row md:gap-5 items-start justify-start right-[4%] w-[89%]">
                <Img
                  src="images/img_h4.png"
                  className="h-[106px] sm:h-auto mb-2 object-cover rounded-[50px] w-[9%] md:w-full"
                  alt="h4"
                />
                <Text
                  className="font-medium md:ml-[0] ml-[30px] md:mt-0 mt-[42px] text-center text-white_A700 w-auto"
                  variant="body2"
                >
                  Haveli Restaurant
                </Text>
                <Img
                  ...
                  className="h-[50px] md:ml-[0] ml-[627px] md:mt-0 mt-16 w-auto"
                  alt="television"
                />
                <Text
                  className="font-medium md:ml-[0] ml-[25px] md:mt-0 mt-[67px] text-center text-white_A700 w-auto"
                  variant="body8"
                >
                  Review
                </Text>
                <HaveliLike1 className="bg-gray_100 flex flex-col items-center justify-start mb-[5px] md:ml-[0] ml-[25px] md:mt-0 mt-16 p-[3px] rounded-[22px] w-auto md:w-full" />
                <Text
                  className="font-medium md:ml-[0] ml-[27px] md:mt-0 mt-[65px] text-center text-white_A700 w-auto"
                  variant="body8"
                >
                  Save
                </Text>
          ...
          <div className="bg-lime_800 border border-black_900 border-solid flex flex-row font-librebodoni items-center justify-start p-1.5 shadow-bs1 w-full">
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start ml-[54px] mt-[13px] md:px-5 w-[68%]">
              ...
              <Img
                ...
                className="h-5 md:ml-[0] ml-[61px] md:mt-0 mt-0.5 w-5"
                alt="dashiconsadmins"
              />
              <a
          ...
          <div className="flex md:flex-col flex-row font-robotoflex gap-7 items-center justify-start md:ml-[0] ml-[76px] mt-[21px] md:px-5 w-[87%] md:w-full">
            <div className="bg-white_A700 h-[449px] md:mt-0 mt-[3px] w-[69%]"></div>
            <div className="flex flex-col items-end justify-start mb-[3px] outline outline-black_900 pl-[7px] py-[7px] shadow-bs1 w-[30%] md:w-full">
              <div className="flex flex-col items-start justify-start mb-[27px] w-[97%] md:w-full">
                ...
                <div className="flex flex-row font-librebodoni items-start justify-start ml-1 md:ml-[0] mt-[22px] w-[51%] md:w-full">
                  <Img
          ...
          <div className="font-roboto h-[673px] mt-[31px] md:px-5 relative w-full">
            <List
              className="sm:flex-col flex-row gap-[19px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 mb-[-24.49px] ml-[76px] pl-1 pt-1 w-[87%] z-[1]"
