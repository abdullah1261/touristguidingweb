    ...
    <>
      <div className="bg-orange_200 flex flex-col items-center justify-start mx-auto pb-1 w-full">
        <div className="flex flex-col justify-start w-full">
          ...
          <div className="font-roboto h-[367px] md:h-[426px] md:px-5 relative w-full">
            <Img
              src="images/img_b21_367x1600.png"
              className="h-[367px] m-auto object-cover w-full"
              alt="b21"
            />
            <div className="absolute bottom-[5%] flex md:flex-col flex-row md:gap-5 inset-x-[0] items-start justify-start mx-auto w-[88%]">
              <Img
              ...
              />
              <Text
                className="font-medium md:ml-[0] ml-[42px] md:mt-0 mt-14 text-left text-white_A700 w-auto"
                variant="body2"
              >
                Butt Karahi Tikka
              </Text>
              <Img
                ...
                className="h-[50px] md:ml-[0] ml-[622px] md:mt-0 mt-[68px] w-auto"
                alt="television"
              />
              <Text
                className="font-medium ml-5 md:ml-[0] md:mt-0 mt-[72px] text-center text-white_A700 w-auto"
                variant="body8"
              >
                Review
              </Text>
              <HaveliLike1 className="bg-gray_100 flex flex-col items-center justify-start mb-1.5 md:ml-[0] ml-[22px] md:mt-0 mt-[67px] p-[3px] rounded-[22px] w-auto md:w-full" />
              <Text
                className="font-medium md:ml-[0] ml-[25px] md:mt-0 mt-[72px] text-center text-white_A700 w-auto"
                variant="body8"
              >
                Save
              </Text>
          ...
          <div className="flex md:flex-col flex-row font-robotoflex gap-[22px] items-center justify-start md:ml-[0] ml-[76px] mt-6 md:px-5 w-[86%] md:w-full">
            ...
            <div className="flex flex-col items-end justify-start outline outline-black_900 pl-[7px] py-[7px] shadow-bs1 w-[30%] md:w-full">
              <div className="flex flex-col items-start justify-start mb-[27px] w-[97%] md:w-full">
                ...
                <div className="flex flex-row font-librebodoni items-start justify-start ml-1 md:ml-[0] mt-[22px] w-[47%] md:w-full">
                  <Img
